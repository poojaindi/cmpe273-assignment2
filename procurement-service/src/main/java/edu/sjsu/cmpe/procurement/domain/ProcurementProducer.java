...
public class ProcurementProducer {
	...
	public ArrayList<String> httpGet() throws JSONException{
			...
			WebResource webResource=client.resource("http://54.193.56.218:9000/orders/16593");
	...
	public void sendBook(String book) throws JMSException{
		...
		String destination_a = "/topic/16593.book.all";
		String destination_b="/topic/16593.book.computer";
