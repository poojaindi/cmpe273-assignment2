...
public class LibraryPublisher {
	    ...
	    public LibraryPublisher(String queueName, String topicName, String libraryName, String apolloHost, String apolloPort, String apolloUser, String apolloPassword){
