...
public class LibraryConsumer {
    ...
    public LibraryConsumer(BookRepositoryInterface bookRepository, String queueName, String topicName, String libraryName, String apolloHost, String apolloPort, String apolloUser, String apolloPassword){
		...
		while (true) {
			...
			while (true) {
				...
				if (msg instanceof TextMessage) {
					...
					if(book != null){
						System.out.println("Book in repo");
